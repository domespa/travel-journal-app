      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="row mb-3">
          <div className="col-md-6">
            <label className="form-label fw-bold">Impegno fisico (1-5)</label>
            <select
          ...
          {/* IMPEGNO ECONOMICO */}
          <div className="col-md-6">
            <label className="form-label fw-bold">Effort economico (1-5)</label>
            <select
        ...
        {/* COSTO */}
        <div className="mb-3">
          <label className="form-label fw-bold">Spesa effettiva (€)</label>
          <input
            type="number"
            name="actual_expense"
